...
import noMutateDateCurrencyFormatTokens from './rules/no-mutate-date-currency-format-tokens.js';
...
const rules = {
  ...
  'no-mutate-date-currency-format-tokens': noMutateDateCurrencyFormatTokens,
};
