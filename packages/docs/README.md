...
| `no-checked-lifecycle-hooks-in-onpush-component`   | Disallows checked lifecycle hooks in OnPush components                                           | [View Documentation](./rules/no-checked-lifecycle-hooks-in-onpush-component.md)   |
